defmodule Uno.RulesTest do
  ...
  describe "card type predicates" do
    ...
    test "wild_card?/1" do
      ...
      assert Rules.wild_card?(card(:blue, "W4"))
  ...
  describe "split_hand/2" do
    test "splits hand into playable and not playable" do
      ...
      {playable, not_playable} = Rules.split_hand(hand, top)
  ...
  describe "sort_by_playability/2" do
    test "puts stronger plays earlier" do
      ...
      sorted = Rules.sort_by_playability(hand, top)
